<?php 
    ...
    $sql = "UPDATE `pant_product` SET `name_product` = '$name_product', `unitprice_product` = '$unitprice_product', `quantity_product` = '$quantity_product' WHERE `id_product` = '$id_product';";
